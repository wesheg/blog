 ...
 *
 * @param event - MouseEvent or TouchEvent on a DOM element
 * @param className - CSS class to apply to the event target
 */
 ...
 *
 * @param event - MouseEvent or TouchEvent on a DOM element
 * @param className - CSS class to remove from the event target
 */
