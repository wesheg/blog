...
export const ClientNavMenu = () => {
  return (
    <div className={styles.navContainer}>
      ...
      <Link href="/" className={`${styles.navItemContainer} ${styles.navLink}`}>about me</Link>
      <Link href="/" className={`${styles.navItemContainer} ${styles.navLink}`}>blog</Link>
      <Link href="/" className={`${styles.navItemContainer} ${styles.navLink}`}>projects</Link>
      <div className={`${styles.navItemContainer} ${styles.socialOuter}`}>
        <div className={styles.socialInner}>
          <Link href="https://www.linkedin.com/in/wes-heginbotham-cfa" className={styles.navigationSocial} target="_blank">
            <Image src="/social/linkedin.png" height={75} width={75} alt="LinkedIn Profile" />
          </Link>
          <Link href="https://bsky.app/profile/wesheg.bsky.social" className={styles.navigationSocial} target="_blank">
            <Image className={styles.navigationOption} src="/social/bluesky.png" height={75} width={75} alt="LinkedIn Profile" />
          </Link>
        </div>
      </div>
    </div>
